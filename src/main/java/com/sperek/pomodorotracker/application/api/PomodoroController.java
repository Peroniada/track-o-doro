...
import com.sperek.pomodorotracker.application.api.query.QueryResolver;
import com.sperek.pomodorotracker.application.security.JWTTokenizer;
import com.sperek.pomodorotracker.domain.PomodoroSessionMapper;
...
public class PomodoroController {
  ...
  private EndpointGroup sessionRoutes = () -> path("sessions", () -> {
    get(documented(getSessionsDoc, getSessions), SecurityUtil.roles(ApiRole.USER));
